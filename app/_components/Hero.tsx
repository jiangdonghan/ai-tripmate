      ...
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <div className="max-w-3xl mx-auto">
          <p className="text-lg text-muted-foreground leading-relaxed">
            Just describe your dream trip and let our AI create the perfect
            itinerary for you. From flights to rental cars and activities, we'll
            handle everything in seconds.
          </p>
        </div>
        ...
        <div className="w-full">
          <h2 className="text-xl flex items-center justify-center gap-2 cursor-pointer mb-10 mt-16">
            ...
            <span className="text-primary font-bold">Watch this video</span>{" "}
